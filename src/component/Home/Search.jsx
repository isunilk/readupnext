...
export const Search = () => {
    ...
    return (
        <div className={`d-flex search-section position-relative mt-5 align-items-center ${style.search}`}>
            <input type="text" name="" placeholder="Search any book, person or series..." id="" className="flex-grow-1 fst-italic" onInput={handleSearch} />
            <button>
