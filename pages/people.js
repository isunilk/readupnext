...
const TeamV1 = () => {
  ...
  const handelScroll = () => {
    ...
    if (
      scrollTop > scrolltopDiv - 70 &&
      !sticky &&
      innerHieght < cardContainerH
    ) {
    ...
    if (scrollTop > scrollHeight - footerHeight - innerHieght) {
      if (fixedDiv) {
        ...
        setStyleTop(
          -(scrollTop - (scrollHeight - footerHeight - innerHieght + 25))
        );
      }
    } else {
      if (fixedDiv) {
  ...
  const peopleCategory = (index, category) => {
    ...
    let firstSibling = document.getElementsByClassName(
      "active-category-sibling1"
    )[0];
    firstSibling
      ? firstSibling.classList.remove("active-category-sibling1")
      : null;

    let secondSibling = document.getElementsByClassName(
      "active-category-sibling2"
    )[0];
    secondSibling
      ? secondSibling.classList.remove("active-category-sibling2")
      : null;
  ...
  const influentialPeopleSchema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "This is a collection of book recommendations by 750+ influential figures. Discover the books that inspire and shape some of the world's greatest minds, from entrepreneurs and artists to scientists and leaders.",
        about: {
          "@type": "ItemList",
          numberOfItems: "764",
          description:
            "List of influential figures and their Recommended books.",
        },
      },
    ],
  };
  ...
  return (
    <>
      ...
      <Head>
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(influentialPeopleSchema),
          }}
        />
      </Head>
      {/* <!-- 
          ...
          <div className="row">
            <div className="col-lg-12" data-aos="fade-right">
              <div className="title-style-five d-flex flex-column align-items-center">
                ...
                <p className="col-lg-10 col-xl-9 text-center">
                  {" "}
                  This is a collection of book recommendations by 700+
                  influential figures. Discover the books that inspire and shape
                  some of the world's greatest minds, from entrepreneurs, and
                  artists to scientists and leaders.
                </p>
      ...
      <div className="team-section-two mt-20">
        <div className="container d-flex flex-column flex-md-row gap-3">
          <div className="people-category col-lg-3 col-md-4">
            <div
              className="people-category-list"
              style={{ top: `${styleTop}px` }}
            >
              <h2
                className="fs-15 pb-2 pt-2 pt-md-0"
                style={{ borderBottom: "2px solid #ffce4c" }}
                onClick={showhideCategory}
              >
                People Types{" "}
                <span className="d-md-none float-right">
              ...
              <ul className="p-0">
                ...
                <li
                  key={0}
                  onClick={() => {
                    peopleCategory(1, "All");
                  }}
                  className="people-category-li active-people list-group-item d-flex justify-content-sm-between py-2 px-3"
                >
                  All
                </li>
                {recommenderCategories.map((item, index) => {
                  return (
                    <li
                      key={index + 1}
                      onClick={() => {
                        peopleCategory(index + 2, item);
                      }}
                      className={`people-category-li list-group-item d-flex justify-content-sm-between py-2 px-3 ${
                        index === 0 ? "active-category-sibling2" : ""
                      }`}
                    >
                      <span>{item}</span>
      ...
      <div
        ...
        style={{
          display: authors.length > 0 ? "none" : "flex",
          background: "#ffffffeb",
          zIndex: "20",
        }}
      >
