        ...
        <>
            ...
            <div className='pt-120 container add-list'>
                ...
                <div className='d-flex steps jsutify-content-between align-items-center py-3'>
                    <span className='active py-1 px-2'>Parent-list</span>
                    <span className={next >= 2 ? 'flex-grow-1 grow active' : "flex-grow-1 grow"}></span>
                    <span className={next >= 2 ? 'py-1 px-2 active' : "py-1 px-2"}>SubList</span>
                ...
                <form action='#' className='col-lg-5 mx-auto border my-3 p-3 rounded' style={{ display: next === 1 ? "block" : "none" }}>
                    <h3 className='fs-5 fw-500 text-center'>Parent List</h3>
                    <label htmlFor="" className='d-block mb-2 '>Add Parent List Name<span className='text-danger'>*</span></label>
                    <input type="text" name='category' className='py-1 px-2 w-100' required onChange={heandleList} />
                    <div className='mt-4 d-flex justify-content-end'>
                        <button className='btn submit-btn' onClick={(e) => { e.preventDefault(); sublist.category.length > 0 ? setNext(2) : alert("All field required") }}>Save</button>
                    </div>
                </form>
                <form action='#' className='col-lg-6 mx-auto border my-3 p-3 rounded' style={{ display: next === 2 ? "block" : "none" }}>
                    ...
                    <label htmlFor="" className='d-block mb-2 '>Add Sub-List Name<span className='text-danger'>*</span></label>
                    ...
                    <label htmlFor="" className='d-block my-2'>Add Parent List Name<span className='text-danger'>*</span></label>
                    <input type="text" className='py-1 px-2 w-100' readOnly value={sublist.category} />
                    <label htmlFor="" className='d-block my-2'>MetaDescription<span className='text-danger'>*</span></label>
                    ...
                    <div className='mt-4 d-flex justify-content-between'>
                        <button type='back' className='btn submit-btn' onClick={() => { setNext(1) }}>Back</button>
                ...
                <form action='#' className='col-lg-8 mx-auto border my-3 p-3 rounded' style={{ display: next === 3 ? "block" : "none" }}>
                    ...
                    <div className='d-flex position-relative gap-2 justify-content-between'>
                    ...
                    <div className='d-flex gap-2 justify-content-between'>
                        <div className='col-lg-5'>
                            ...
                            <input type="text" className='py-1 px-2 w-100' name='authorName' value={book.authorName} onChange={handlBook} />
                        </div>
                    ...
                    <div className='d-flex gap-2 justify-content-between'>
                        <div className='col-lg-5'>
                            ...
                            <input type="number" min="0.1" max="5.0" className='py-1 px-2 w-100' value={book.rating} name='rating' onChange={handlBook} placeholder='4.2' />
                        </div>
                        <div className='col-lg-6'>
                            <label htmlFor="" className='d-block my-2'>Review Count<span className='text-danger'>*</span></label>
                            <input type="number" min="0" className='py-1 px-2 w-100' name='reviewCount' value={book.reviewCount} onChange={handlBook} placeholder='40425' />
                        </div>
                    </div>
                    <div className='d-flex gap-2 justify-content-between'>
                        <div className='col-lg-5'>
                            <label htmlFor="" className='d-block my-2'>Slug<span className='text-danger'>*</span></label>
                            <input type="text" className='py-1 px-2 w-100 text-lowercase' name='slug' value={book.slug} placeholder='title-red-alert' onChange={handlBook} />
                        </div>
                        <div className='col-lg-6'>
                            <label htmlFor="" className='d-block my-2'>Year of Published</label>
                            <input type='number' className='py-1 px-2 w-100' max="2050" name='yearPublished' value={book.yearPublished} placeholder='1989' onChange={handlBook} />
                        </div>
                    </div>
                    <label htmlFor="" className='d-block my-2'>Buy Link</label>
                    <input type="text" className='py-1 px-2 w-100' name='buyLink' placeholder='https://' value={book.buyLink} onChange={handlBook} />
                    <label htmlFor="" className='d-block my-2'>Book Image URL</label>
                    <input type="text" className='py-1 px-2 w-100' name='BookimageUrl' placeholder='https://' value={book.BookimageUrl} onChange={handlBook} />
                    ...
                    <div className='mt-4 d-flex justify-content-between'>
                        <button type='back' className='btn submit-btn' onClick={() => { setNext(2) }}>Back</button>
