                ...
                {active === index ?
                    <button className="border-0 bg-transparent position-absolute" style={{ right: "10px", top: "10px" }} onClick={()=>setActive(null)}>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10.9264 20.1666C15.9681 20.1666 20.0931 16.0416 20.0931 10.9999C20.0931 5.95825 15.9681 1.83325 10.9264 1.83325C5.88477 1.83325 1.75977 5.95825 1.75977 10.9999C1.75977 16.0416 5.88477 20.1666 10.9264 20.1666Z" stroke="#292D32" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <button className="border-0 bg-transparent position-absolute" style={{ right: "10px", top: "50%", transform:"translateY(-50%)" }} onClick={()=>setActive(index)}>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.0007 20.1666C16.0423 20.1666 20.1673 16.0416 20.1673 10.9999C20.1673 5.95825 16.0423 1.83325 11.0007 1.83325C5.95898 1.83325 1.83398 5.95825 1.83398 10.9999C1.83398 16.0416 5.95898 20.1666 11.0007 20.1666Z" stroke="#292D32" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
