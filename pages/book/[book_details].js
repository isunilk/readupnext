...
const Book_Details = ({ data, errorCode }) => {
  ...
  return (
    <>
      <Seo
        pageTitle={`${booksDetails ? booksDetails.title : "Book"} by ${
          booksDetails.authorName
      ...
      <div className="container team-section-two d-flex flex-column align-items-center mt-20">
        <div
          className="d-flex align-items-center col-12 justify-content-between"
          style={{ borderBottom: "3px solid #c475e3" }}
        >
          <h2 className="fs-20 tx-new fw-500 w-75">
            Books Similar to {booksDetails ? booksDetails.title : ""}
          </h2>
      ...
      <div
        ...
        style={{
          display: similarBooks.length > 0 ? "none" : "flex",
          background: "#ffffffeb",
          zIndex: "20",
        }}
      >
...
//     `${process.env.NEXT_API_URL}/api/book-similar-books?book=${book_details}`
//   );
