    ...
    <>
      ...
      <ul className="list-unstyled text-center d-flex flex-wrap">
        <li className="nav-item my-1">
          <button
            className={filter === "*" ? "active navigator" : "navigator"}
            onClick={() => setFilter("*")}
          >
            All
          </button>
        ...
        <li className="nav-item my-1">
          <button
            className={filter === "Best Cinematography Books" ? "active navigator" : "navigator"}
        ...
        <li className="nav-item my-1">
          <button
            className={filter === "Best SEO Books" ? "active navigator" : "navigator"}
        ...
        <li className="nav-item my-1">
          <button
            className={filter === "Best Learning Books" ? "active navigator" : "navigator"}
        ...
        <li className="nav-item my-1">
          <button
            className={filter === "Best Pirate Books" ? "active navigator" : "navigator"}
        ...
        <li className="nav-item my-1">
          <button
            className={filter === "Best Fiction Books" ? "active navigator" : "navigator"}
        ...
        <li className="nav-item my-1">
          <button
            className={
              filter === "Best Romance Books" ? "active navigator" : "navigator"
            }
      ...
      {/* <div className="slider-wrapper">
        ...
        > */}
      <div className={"slider-container pt-5 position-relative "+style.crousel_container }>
        <div className={style.crouselwidth}>
          <Slider {...settings} arrows={false}>
            {filteredItems.map((course) => (
              <div className="px-2 py-2">
                <div className={`py-3 ${style.bookcard}`} style={{ width: "280px" }}>
                  ...
                  <div className="d-flex flex-column justify-content-center align-items-center  mt-3">
                    <Link href={"/book/" + course.slug} className="text-decoration-none text-dark fs-4  text-nowrap text-center w-100">
                      {course.title}
                    </Link>
                    <div className="d-flex text-center align-items-center justify-content-center">
                      {course.instructor}
                    </div>
                    <div className="course-review d-flex align-items-center justify-content-center mb-3 mt-2">
                    ...
                    <Link
                      ...
                      className="yellow_button text-decoration-none position-relative px-2 text-center "
                    >
                      View on Amazon
                    </Link>
